/**
 * ResourceSpec + ColumnDef for Du An (project view) list table.
 ...
 * The du-an-list-client.tsx defines its own column array with JSX renders; this
...
export const DU_AN_COLUMNS: ColumnDef<Record<string, unknown>>[] = [
  {
    key: "code",
    header: "Mã DA",
    kind: "text",
  ...
  },
  {
    ...
    kind: "date",
    className: "w-[120px]",
    // Business date — not inline editable
  },
  {
    key: "endDate",
    header: "Hoàn thành",
...
export const DU_AN_SPEC: ResourceSpec = deriveResourceSpec(DU_AN_COLUMNS, {
