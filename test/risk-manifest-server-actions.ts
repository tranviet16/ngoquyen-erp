...
export const SERVER_ACTION_RISK_MANIFEST: readonly RiskManifestRecord[] = [
  ...
  action("action-roles", "app/(app)/admin/permissions/roles/actions.ts", "P0", "administration", defined("authorized administrator role lifecycle policy")),
  ...
  action("action-receivables", "app/(app)/tai-chinh/phai-thu-tra/actions.ts", "P1", "finance", defined("finance module access policy")),
  ...
  action("action-lot-catalog", "app/(app)/sl-dt/danh-muc-lo/actions.ts", "P1", "operations", defined("SL-DT module access policy")),
