...
| Info | Informational | https://admin-pc.tail8998df.ts.net | Percentage of responses with status code 2xx | 91 % |
| Info | Informational | https://admin-pc.tail8998df.ts.net | Percentage of responses with status code 3xx | 8 % |
| Info | Informational | https://admin-pc.tail8998df.ts.net | Percentage of endpoints with content type application/javascript | 50 % |
| Info | Informational | https://admin-pc.tail8998df.ts.net | Percentage of endpoints with content type font/woff2 | 31 % |
...
| Info | Informational | https://admin-pc.tail8998df.ts.net | Percentage of endpoints with content type text/html | 3 % |
| Info | Informational | https://admin-pc.tail8998df.ts.net | Percentage of endpoints with method GET | 100 % |
| Info | Informational | https://admin-pc.tail8998df.ts.net | Count of total endpoints | 32    |
| Info | Informational | https://admin-pc.tail8998df.ts.net | Percentage of slow responses | 69 % |
...
* URL: https://admin-pc.tail8998df.ts.net
  ...
  * Parameter: ``
  * Attack: ``
  * Evidence: `<script src="/_next/static/chunks/1fwxhcgd98n4v.js" async="" nonce="ZWI4NDA1NzUtNjkzMi00NjE1LWFhMGMtZmVjNWYzZmFlOTI2"></script>`
...
* URL: https://admin-pc.tail8998df.ts.net/login%3FcallbackUrl=%252Fsitemap.xml
  ...
  * Parameter: ``
  * Attack: ``
  * Evidence: `<script src="/_next/static/chunks/1fwxhcgd98n4v.js" async="" nonce="MDM1NjQ4ZGMtNDVhYy00NDZkLThjYTQtYWUzMGI3MjFmZjc0"></script>`
  * Other Info: `No links have been found while there are scripts, which is an indication that this is a modern web application.`
* URL: https://admin-pc.tail8998df.ts.net/login%3FcallbackUrl=%252Frobots.txt
  ...
  * Parameter: ``
  * Attack: ``
  * Evidence: `<script src="/_next/static/chunks/1fwxhcgd98n4v.js" async="" nonce="NDAwMzhkZmItMGJmNC00NTBmLWI4MjAtOWExODRhN2NkYjRh"></script>`
  * Other Info: `No links have been found while there are scripts, which is an indication that this is a modern web application.`
* URL: https://admin-pc.tail8998df.ts.net/login%3FcallbackUrl=%252F
  ...
  * Parameter: ``
  * Attack: ``
  * Evidence: `<script src="/_next/static/chunks/1fwxhcgd98n4v.js" async="" nonce="YjM5ZjczMWEtNjRhMy00OGQ5LThhMGYtODMxYTNmNjc3ZTU5"></script>`
  * Other Info: `No links have been found while there are scripts, which is an indication that this is a modern web application.`
