...
| Info | Informational | https://admin-pc.tail8998df.ts.net | Percentage of slow responses | 18 % |
...
* URL: https://admin-pc.tail8998df.ts.net/login%3FcallbackUrl=%252F
  ...
  * Parameter: ``
  * Attack: ``
  * Evidence: `<script src="/_next/static/chunks/1fwxhcgd98n4v.js" async="" nonce="NzI0MWNmZmYtZmU0OC00N2QwLTg4ZDctNDhkOWVmNGJiMWY4"></script>`
...
* URL: https://admin-pc.tail8998df.ts.net/login%3FcallbackUrl=%252Frobots.txt
  ...
  * Parameter: ``
  * Attack: ``
  * Evidence: `<script src="/_next/static/chunks/1fwxhcgd98n4v.js" async="" nonce="ODBhYmE4YWUtMjQ4YS00MDBjLWE1MzMtODJmNWI4OTJiOGM0"></script>`
  * Other Info: `No links have been found while there are scripts, which is an indication that this is a modern web application.`
* URL: https://admin-pc.tail8998df.ts.net/login%3FcallbackUrl=%252Fsitemap.xml
  ...
  * Parameter: ``
  * Attack: ``
  * Evidence: `<script src="/_next/static/chunks/1fwxhcgd98n4v.js" async="" nonce="YmI1NmNlOTItODVjZS00OTQ3LWE5YmItNWIyOTUyZGM2ZmE5"></script>`
  * Other Info: `No links have been found while there are scripts, which is an indication that this is a modern web application.`
* URL: https://admin-pc.tail8998df.ts.net/login%3FcallbackUrl=%252F
  * Node Name: `https://admin-pc.tail8998df.ts.net/login (callbackUrl)`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: `<script src="/_next/static/chunks/1fwxhcgd98n4v.js" async="" nonce="ZjJmODU5OTUtYTc2ZS00ODczLTliMjktZmJiNDdlZWUyNjNl"></script>`
  * Other Info: `No links have been found while there are scripts, which is an indication that this is a modern web application.`
