...
import { SortableDoanhThuReportTable } from "@/components/sl-dt/sortable-doanh-thu-report-table";
import { MonthYearPicker } from "@/components/ui/month-year-picker";
import { getAvailableMonths, getDoanhThuReport } from "@/lib/sl-dt/report-service";
...
export default async function BaoCaoDtPage({ searchParams }: Props) {
  ...
  return (
    <div className="space-y-4">
      ...
      <SortableDoanhThuReportTable rows={rows} year={year} month={month} />
    </div>
  );
}
