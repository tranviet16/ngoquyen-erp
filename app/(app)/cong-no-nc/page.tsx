  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">Công nợ Nhân công</h1>
          <p className="text-sm text-muted-foreground">Tổng hợp công nợ TT/HĐ theo Chủ thể × Đội thi công × Dự án</p>
        </div>
        ...
        <table className="w-full text-sm border-collapse">
          <thead>
            <tr className="bg-muted">
              ...
              <th className="border-b p-2 text-left">Đội thi công</th>
            ...
            {summaryRows.length === 0 ? (
              ...
              summaryRows.map((r, idx) => (
                <tr key={idx} className="hover:bg-muted/30">
                  ...
                  <td className="border-b p-2">{contractorMap[r.partyId] ?? `#${r.partyId}`}</td>
